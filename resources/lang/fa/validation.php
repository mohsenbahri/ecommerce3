...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'attribute_is_filter_ids'               => 'ویژگی هایی که قابلیت فیلتر شدن را دارند',
        'variation_id'               => 'متغیر',
        'type'               => 'نوع',
        'amount'               => 'مقدار',
        'percentage'               => 'درصد',
        'max_percentage_amount'               => 'حداکثر مقدار درصدی',
        'expired_at'               => 'تاریخ انقضا',
        'product_id'               => 'محصول',
        'value'               => 'مقدار ویژگی',
        'is_active'               => 'نوع از نظر فعال بودن',
        'primary_image'               => 'تصویر اصلی',
        'images'               => 'تصاویر',
        'category_id'               => 'دسته بندی',
        'variation_values'               => 'مقادیر متغیرها',
